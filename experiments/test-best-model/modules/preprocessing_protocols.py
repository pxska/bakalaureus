...
token_splitter = TokenSplitter(patterns=[re.compile(r'(?P<end>[A-ZÕÄÖÜ]{1}\w+)[A-ZÕÄÖÜ]{1}\w+'),\
                                         re.compile(r'(?P<end>wallast)Jürri'),\
                                         re.compile(r'(?P<end>Blumbaum)Koddaso'),\
                                         re.compile(r'(?P<end>Uwits)minna'),\
                                         re.compile(r'(?P<end>moistmas)Mihkel'),\
                                         re.compile(r'(?P<end>kohtowannem)Jaak'),\
                                         re.compile(r'(?P<end>wallast)Käeselja'),\
                                         re.compile(r'(?P<end>rae)päält'),\
                                         re.compile(r'(?P<end>Kots)seddä'),\
                                         re.compile(r'(?P<end>Pajusse)mees'),\
                                         re.compile(r'(?P<end>Lodij)mees'),\
                                         re.compile(r'(?P<end>Lodij)mehhel'),\
                                         re.compile(r'(?P<end>lody)mees'),\
                                         re.compile(r'(?P<end>Lody)mees'),\
                                         re.compile(r'(?P<end>Jaak)kummage'),\
                                         re.compile(r'(?P<end>körtsist)hobbune')])
