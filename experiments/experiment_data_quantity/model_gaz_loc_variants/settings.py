...
GAZETTEER_FILE = 'gazetteer_both_lowercase_added_loc_and_variants.txt'
...
FEATURE_EXTRACTORS = (
    "protocols_fex.NerEmptyFeatureTagger",
    "protocols_fex.NerLocalFeatureWithoutMorphTagger",
    "protocols_fex.NerBasicMorphFeatureTagger",
    "estnltk.taggers.estner.fex.NerSentenceFeatureTagger",
    "protocols_fex.NerGazetteerFeatureTagger",
